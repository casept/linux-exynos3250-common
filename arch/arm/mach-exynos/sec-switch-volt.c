...
void ztw522_tsp_charger_infom(int cable_type, int attach)
{
	...
	case MUIC_CABLE_TYPE_NONE:
	case MUIC_CABLE_TYPE_UART:
	case MUIC_CABLE_TYPE_USB:
	case MUIC_CABLE_TYPE_REGULAR_TA:
	case MUIC_CABLE_TYPE_ATT_TA:
	case MUIC_CABLE_TYPE_0x15:
	case MUIC_CABLE_TYPE_TYPE1_CHARGER:
	case MUIC_CABLE_TYPE_0x1A:
	...
	case MUIC_CABLE_TYPE_L_USB:
	case MUIC_CABLE_TYPE_UNKNOWN:
	case MUIC_CABLE_TYPE_INVALID:
	case MUIC_CABLE_TYPE_OTG_WITH_VBUS:
	case MUIC_CABLE_TYPE_SAMSUNG_PS:
		ztw522_charger_callbacks->inform_charger(ztw522_charger_callbacks, attach);
		break;
	case MUIC_CABLE_TYPE_OTG:
