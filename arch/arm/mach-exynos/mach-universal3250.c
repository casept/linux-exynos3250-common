...
#if defined(CONFIG_BT_BCM4334W) || defined(CONFIG_BT_BCM43436L)
...
#elif defined(CONFIG_BT_BCM43436L)
static struct platform_device bcm43436l_bluetooth_device = {
...
static struct platform_device ff_dc_haptic_device = {
        .name = "ff-dc-vibrator",
        .dev.platform_data = &ff_dc_vibrator_data,
};
#endif /* end CONFIG_FF_DC_VIBRATOR */
#endif /* end CONFIG_MACH_VOLT*/

#ifdef CONFIG_MST_LDO
static struct platform_device mst_ldo_device = {
	.name = "mstldo",
};
#endif
...
#if defined(CONFIG_BT_BCM43436L) || defined(CONFIG_BT_BCM4334W)
...
#ifdef CONFIG_MACH_SMARTKEY
	exynos3_smartkey_battery_init();
	exynos3_smartkey_mfd_init();
#else
...
MACHINE_START(SMARTKEY, "SMARTKEY")
	.init_irq	= exynos3_init_irq,
	.init_early	= universal3250_init_early,
	.map_io		= universal3250_map_io,
	.handle_irq	= gic_handle_irq,
