...
void exynos3_orbis_audio_init(void);
void exynos3_sensor_init(void);
...
void exynos3_i2s_dummy_audio_init(void);
void exynos3_smartkey_mfd_init(void);
void exynos3_smartkey_battery_init(void);
#ifdef CONFIG_WLAN
void brcm_wlan_init(void);
#endif
#ifdef CONFIG_NFC
void tizen_nfc_init(void);
#endif
#ifdef CONFIG_ESE_P3_LSI
void exynos3_orbis_ese_p3_init(void);
#endif
#endif
