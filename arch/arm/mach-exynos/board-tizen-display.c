...
#ifdef CONFIG_EXYNOS_LCD_S6E36W0X01
#define TIZEN3250_XRES		360
#define TIZEN3250_YRES		480
#define TIZEN3250_VIRTUAL_X	360
#define TIZEN3250_VIRTUAL_Y	(480 * 2)
#elif defined(CONFIG_EXYNOS_LCD_S6E36W1X01)
#define TIZEN3250_XRES		360
#define TIZEN3250_YRES		360
#define TIZEN3250_VIRTUAL_X	360
#define TIZEN3250_VIRTUAL_Y	(360 * 2)
#elif defined(CONFIG_EXYNOS_LCD_S6E36W1X01_VOLT)
#define TIZEN3250_XRES		216
#define TIZEN3250_YRES		432
#define TIZEN3250_VIRTUAL_X	216
#define TIZEN3250_VIRTUAL_Y	(432 * 2)
#else
...
#ifdef CONFIG_EXYNOS_LCD_S6E36W0X01
static struct lcd_property s6e36w0x01_property = {
...
static struct lcd_platform_data s6e36w0x01_pdata = {
	.reset			= reset_lcd,
	.reset_delay		= 10,
	.power_off_delay		= 130,
	.power_on_delay		= 25,
	.lcd_enabled		= 1,
	.pdata	= &s6e36w0x01_property,
};
#elif defined(CONFIG_EXYNOS_LCD_S6E36W1X01)
static struct lcd_property s6e36w1x01_property = {
	.reset_low = reset_lcd_low,
#ifdef CONFIG_LCD_ESD
	.det_gpio = EXYNOS3_GPX3(0),
	.err_gpio = EXYNOS3_GPX3(2),
#endif
	.te_gpio = EXYNOS3_GPX0(6),
	.enable_mdnie = true,
};

static struct lcd_platform_data s6e36w1x01_pdata = {
	.reset			= reset_lcd,
	.reset_delay		= 10,
	.power_off_delay		= 130,
	.power_on_delay		= 10,
	.lcd_enabled		= 1,
	.pdata	= &s6e36w1x01_property,
};
#elif defined(CONFIG_EXYNOS_LCD_S6E36W1X01_VOLT)
static struct lcd_property s6e36w1x01_property = {
	.reset_low = reset_lcd_low,
...
#if defined (CONFIG_EXYNOS_LCD_S6E36W1X01)
	.p = 4,
	.m = 128,
	.s = 1,
#elif defined (CONFIG_EXYNOS_LCD_S6E36W1X01_VOLT)
...
static struct mipi_dsim_lcd_device mipi_lcd_device = {
	...
	.id			= -1,
	.bus_id			= 0,
	.platform_data		= (void *)&s6e36w0x01_pdata,
};
#elif defined(CONFIG_EXYNOS_LCD_S6E36W1X01)
static struct mipi_dsim_lcd_device mipi_lcd_device = {
	.name			= "s6e36w1x01",
	.id			= -1,
	.bus_id			= 0,
	.platform_data		= (void *)&s6e36w1x01_pdata,
};
#elif defined(CONFIG_EXYNOS_LCD_S6E36W1X01_VOLT)
static struct mipi_dsim_lcd_device mipi_lcd_device = {
	.name			= "s6e36w1x01",
...
static struct exynos_drm_mode_info drm_fimd_modes[] = {
	[0] = {
		.refresh = TIZEN3250_MAX_HZ,
		.vmode = FB_VMODE_NONINTERLACED,
	},
};

static struct exynos_drm_panel_info drm_fimd_panel = {
	.timing	= {
		.xres		= TIZEN3250_XRES,
		.yres		= TIZEN3250_YRES,
...
#ifdef CONFIG_EXYNOS_LCD_S6E36W0X01
	strcpy(dsim_pd->lcd_panel_name, "s6e36w0x01");
#elif defined(CONFIG_EXYNOS_LCD_S6E36W1X01)
	strcpy(dsim_pd->lcd_panel_name, "s6e36w1x01");
#elif defined(CONFIG_EXYNOS_LCD_S6E36W1X01_VOLT)
	strcpy(dsim_pd->lcd_panel_name, "s6e36w1x01");
#else
