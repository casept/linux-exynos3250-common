...
static struct regulator_consumer_supply s2mps14_ldo3_consumer[] = {
	...
	REGULATOR_SUPPLY("CPVDD", "largo-codec"),
	REGULATOR_SUPPLY("SPKVDD", "largo-codec"),
	REGULATOR_SUPPLY("MICVDD", "largo-codec"),
};
...
static struct regulator_consumer_supply s2mps14_ldo13_consumer =
	REGULATOR_SUPPLY("MST_LEVEL_3.0V", NULL);

static struct regulator_consumer_supply s2mps14_ldo14_consumer =
	REGULATOR_SUPPLY("vdd_ofm_2.8v", NULL);

static struct regulator_consumer_supply s2mps14_ldo14_rev14_consumer =
	REGULATOR_SUPPLY("vdd_hrm_io_1.8v", NULL);
...
static struct regulator_consumer_supply s2mps14_ldo17_consumer =
	REGULATOR_SUPPLY("vdd_hrm_led_3.3", NULL);
...
static struct regulator_consumer_supply s2mps14_ldo21_consumer =
	REGULATOR_SUPPLY("vdd_hub_io_1.8", NULL);

static struct regulator_consumer_supply s2mps14_ldo22_consumer =
	REGULATOR_SUPPLY("DCVDD", "spi1.0");
...
static struct regulator_consumer_supply s2mps14_ldo24_consumer =
	REGULATOR_SUPPLY("vdd_hrm_io_1.8_old", NULL);

static struct regulator_consumer_supply s2mps14_ldo25_consumer =
	REGULATOR_SUPPLY("vdd_ese_1.8", NULL);
...
static struct regulator_init_data s2m_ldo3_data = {
	...
	.num_consumer_supplies  = ARRAY_SIZE(s2mps14_ldo3_consumer),
	.consumer_supplies      = &s2mps14_ldo3_consumer[0],
};
...
static struct regulator_init_data s2m_ldo14_rev14_data = {
	.constraints    = {
		.name           = "vdd_hrm_io_1.8",
		.min_uV         = 1800000,
		.max_uV         = 1800000,
	...
	.num_consumer_supplies  = 1,
	.consumer_supplies      = &s2mps14_ldo14_rev14_consumer,
};
...
static struct regulator_init_data s2m_ldo25_data = {
	...
	.num_consumer_supplies  = 1,
	.consumer_supplies      = &s2mps14_ldo25_consumer,
};
...
struct sec_opmode_data s2mps14_opmode_data[S2MPS14_REG_MAX] = {
	...
	[S2MPS14_LDO2] = {S2MPS14_LDO2, SEC_OPMODE_STANDBY},
	...
	[S2MPS14_LDO14] = {S2MPS14_LDO14, SEC_OPMODE_NORMAL},
	[S2MPS14_LDO15] = {S2MPS14_LDO15, SEC_OPMODE_NORMAL},
	[S2MPS14_LDO16] = {S2MPS14_LDO16, SEC_OPMODE_NORMAL},
	[S2MPS14_LDO17] = {S2MPS14_LDO17, SEC_OPMODE_NORMAL},
	...
	[S2MPS14_LDO21] = {S2MPS14_LDO21, SEC_OPMODE_NORMAL},
	[S2MPS14_LDO22] = {S2MPS14_LDO22, SEC_OPMODE_STANDBY},
	[S2MPS14_LDO23] = {S2MPS14_LDO23, SEC_OPMODE_NORMAL},
	[S2MPS14_LDO24] = {S2MPS14_LDO24, SEC_OPMODE_NORMAL},
	[S2MPS14_LDO25] = {S2MPS14_LDO25, SEC_OPMODE_NORMAL},
};
...
#endif
	if (system_rev >= 11) {
		exynos_regulators[12].initdata = &s2m_ldo14_rev14_data;
		printk("Change data of LDO14 from ofm_2.8v to hrm_io_1.8v. rev=0x%x\n", system_rev);
	}
