...
#define GPIO_FUEL_SCL		EXYNOS3_GPD1(1)
#define GPIO_FUEL_SDA		EXYNOS3_GPD1(0)
...
/* For MAX17048 */
#ifdef CONFIG_FUELGAUGE_MAX17048
...
sec_battery_platform_data_t sec_battery_pdata = {
	...
	.gpio_fuelgauge_switch = EXYNOS3_GPX2(1),
	.gpio_fg_switch_enable_setting = 1,
...
void __init exynos3_universal3250_battery_init(void)
{
	...
	if (system_rev >= 5) {
		sec_battery_pdata.gpio_fuelgauge_switch2 = EXYNOS3_GPX2(0);
		sec_battery_pdata.gpio_fg_switch2_enable_setting = 0;
	} else if (system_rev == 4) {
		sec_battery_pdata.gpio_fuelgauge_switch2 = EXYNOS3_GPX2(0);
		sec_battery_pdata.gpio_fg_switch2_enable_setting = 1;
	}
