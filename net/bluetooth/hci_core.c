...
#ifdef CONFIG_TIZEN_WIP
	BT_INFO("[BT] Sending First HCI packet(0x1003)");
#endif
...
#ifdef CONFIG_TIZEN_WIP
	snprintf(hdev->hci_rx_wake_lock_name, sizeof(hdev->hci_rx_wake_lock_name),
			"BT_rx_wake");
...
#ifdef CONFIG_SYSTEM_LOAD_ANALYZER
	store_external_load_factor(CONN_BT_RX, skb->len);
#endif
...
#ifdef CONFIG_SYSTEM_LOAD_ANALYZER
	store_external_load_factor(CONN_BT_TX, skb->len);
#endif
