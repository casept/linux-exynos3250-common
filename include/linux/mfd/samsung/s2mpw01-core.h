...
extern void s2mpw01_irq_exit(struct sec_pmic_dev *s2mpw01);
...
extern int sec_pmic_read(struct sec_pmic_dev *sec_pmic, u32 reg, void *dest);
extern int sec_pmic_bulk_read(struct sec_pmic_dev *sec_pmic, u32 reg, int count,
				u8 *buf);
extern int sec_pmic_write(struct sec_pmic_dev *sec_pmic, u32 reg, u32 value);
extern int sec_pmic_bulk_write(struct sec_pmic_dev *sec_pmic, u32 reg, int count,
				u8 *buf);
extern int sec_pmic_update(struct sec_pmic_dev *sec_pmic, u32 reg, u32 val,
				u32 mask);
...
extern int sec_chg_read(struct sec_pmic_dev *sec_pmic, u32 reg, void *dest);
extern int sec_chg_bulk_read(struct sec_pmic_dev *sec_pmic, u32 reg, int count,
				u8 *buf);
extern int sec_chg_write(struct sec_pmic_dev *sec_pmic, u32 reg, u32 value);
extern int sec_chg_bulk_write(struct sec_pmic_dev *sec_pmic, u32 reg, int count,
				u8 *buf);
extern int sec_chg_update(struct sec_pmic_dev *sec_pmic, u32 reg, u32 val,
				u32 mask);

extern int sec_fg_read(struct sec_pmic_dev *sec_pmic, u32 reg, void *dest);
extern int sec_fg_bulk_read(struct sec_pmic_dev *sec_pmic, u32 reg, int count,
				u8 *buf);
extern int sec_fg_write(struct sec_pmic_dev *sec_pmic, u32 reg, u32 value);
extern int sec_fg_bulk_write(struct sec_pmic_dev *sec_pmic, u32 reg, int count,
				u8 *buf);
extern int sec_fg_update(struct sec_pmic_dev *sec_pmic, u32 reg, u32 val,
				u32 mask);
