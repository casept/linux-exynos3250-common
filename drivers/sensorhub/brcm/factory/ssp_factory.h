...
void initialize_ms5837_pressure_factorytest(struct ssp_data *);
...
void remove_ms5837_pressure_factorytest(struct ssp_data *);
...
int ms5837_pressure_open_calibration(struct ssp_data *);
...
int ms5837_set_pressure_cal(struct ssp_data *);
